local booster_info = SMODS.Booster({
	...
	create_card = function(self, card)
		...
		if card.ability.cards_made < card.ability.extra/2 then 
			card_to_make = create_card("D6 Joker", G.pack_cards, nil, nil, true, true, nil, 'dsix_booster')
		else 
			card_to_make = create_card("Dice Modifiers", G.pack_cards, nil, nil, true, true, nil, 'dsix_booster')
		end
